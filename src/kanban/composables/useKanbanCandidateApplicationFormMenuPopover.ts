...
function hasActiveSection() {
  return isActiveSection(SECTIONS.ADD_FILE)
    || isActiveSection(SECTIONS.DELETE_FILE)
    || isActiveSection(SECTIONS.DOWNLOAD_FILE)
}
...
export function useKanbanCandidateApplicationFormMenuPopover() {
  return {
